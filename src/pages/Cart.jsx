      ...
      <Wrapper>
        ...
        <Bottom>
          ...
          <Summary>
            ...
            <StripeCheckout name="BYit" image='#' billingAddress shippingAddress description={`Your total bill is Rs. ${cart.total}`} amount={cart.total*100} token={onToken} stripeKey={KEY}>
